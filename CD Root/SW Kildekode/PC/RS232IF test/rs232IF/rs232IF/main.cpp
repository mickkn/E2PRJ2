...
int main()
{
	...
	while(testing)
	{
		cout << "LoginValid kaldes og sender SL9999." << endl << "read() læser og udskriver beskeden og returnere 0: " << endl;
		objRS.validLogin();
		int test0 = objRS.read();
		cout << "read returnerede: " << test0 << endl << endl;
