...
Generelt kan det overordnede hardware design beskrives som noget elektronik der sender information ud på det nettet, som sendes og analyseres af noget elektronik i den anden ende. Disse vil blive beskrevet herunder som encoder og decoder.  
